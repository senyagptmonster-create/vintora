...
class AppTheme {
  static const Color cBg = Color(0xFFFBF8F5);
  static const Color cSurface = Color(0xFFFFFFFF);
  static const Color cEdge = Color(0xFFEFE6DE);
  static const Color cAccent = Color(0xFF78350F);
  static const Color cAccent2 = Color(0xFFD97706);
  static const Color cInk = Color(0xFF451A03);
